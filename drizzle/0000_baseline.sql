...
CREATE TABLE "MarketConfig" (
	...
	"adminRoleIds" text[] DEFAULT '{}' NOT NULL,
...
CREATE TABLE "User" (
	...
	"avatarUrl" text,
	"guildRoles" text[] DEFAULT '{}' NOT NULL,
	"createdAt" timestamp (3) DEFAULT CURRENT_TIMESTAMP NOT NULL
);
--> statement-breakpoint
...
CREATE INDEX "BisEntry_stageId_slot_position_idx" ON "BisEntry" USING btree ("stageId" int4_ops,"slot" int4_ops,"position" int4_ops);--> statement-breakpoint
...
CREATE INDEX "SavedSearch_userId_idx" ON "SavedSearch" USING btree ("userId" text_ops);